  ...
  async run (options) {
    ...
    if (help) {
      return buntstift.info(getUsage([
        { header: 'wolkenkit application export', content: this.description },
        { header: 'Synopsis', content: stripIndent`
          wolkenkit application export [--env <env>] --to=<directory> [--from-event-store]` },
    ...
    try {
      await wolkenkit.commands.application.export({
        directory,
        env,
        fromEventStore,
        to
